package com.settlex.android.presentation.common.custom;
...
public class SettleXProgressLoader extends View {
    ...
    public SettleXProgressLoader(Context context) {
        super(context);
        init();
    }

    public SettleXProgressLoader(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
